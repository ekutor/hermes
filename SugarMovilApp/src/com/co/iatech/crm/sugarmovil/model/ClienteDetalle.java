 ...
 */
public class ClienteDetalle implements Parcelable {
    ...
    protected ClienteDetalle(Parcel in) {
        ...
        refered_by = in.readString();
        lead_source = in.readString();
        lead_source_description = in.readString();
        status = in.readString();
        status_description = in.readString();
        ...
        opportunity_id = in.readString();
        opportunity_name = in.readString();
        opportunity_amount = in.readString();
        campaign_id = in.readString();
        birthdate = in.readString();
        portal_name = in.readString();
        portal_app = in.readString();
        website = in.readString();
        id_c = in.readString();
        razonsocial_c = in.readString();
        accion_c = in.readString();
        fecha_c = in.readString();
        fecha2_c = in.readString();
        fecha3_c = in.readString();
        retroalimentacion2_c = in.readString();
        retroalimentacion3_c = in.readString();
        responsable_c = in.readString();
        responsable2_c = in.readString();
        responsable3_c = in.readString();
        fuente_c = in.readString();
        medio_c = in.readString();
        otro_c = in.readString();
        tiposolicitud_c = in.readString();
        valor_real_c = in.readString();
