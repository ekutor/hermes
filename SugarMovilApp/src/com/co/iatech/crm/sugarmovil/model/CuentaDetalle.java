...
public class CuentaDetalle extends GenericBean implements Parcelable  {
    ...
    public static final Parcelable.Creator<CuentaDetalle> CREATOR = new Parcelable.Creator<CuentaDetalle>() {
        @Override
        public CuentaDetalle createFromParcel(Parcel in) {
            return new CuentaDetalle(in);
        }

        @Override
        public CuentaDetalle[] newArray(int size) {
            return new CuentaDetalle[size];
        }
    };
    ...
    public String getAlianzasestrategicas_c() {
        return alianzasestrategicas_c;
    }
    ...
    public String getNumeroalianzas_c() {
        return numeroalianzas_c;
    }
