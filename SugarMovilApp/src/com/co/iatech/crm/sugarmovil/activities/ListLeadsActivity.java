...
public class ListLeadsActivity extends LeadsModuleActions {

    /**
     * Member Variables.
     */  
    private List<Lead> tasksXParent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tasksXParent = new ArrayList<Lead>();
        getInfoFromMediator();
        ...
        mToolbarTextView.setText("SELECCIONAR CLIENTE");
        ...
        mRecyclerViewLayoutManager = new LinearLayoutManager(ListLeadsActivity.this);
        ...
        mSearchView.setOnCloseListener(new SearchView.OnCloseListener() {
            ...
            public boolean onClose() {
                ...
                InputMethodManager imm = (InputMethodManager) ListLeadsActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
	...
	public void chargeViewInfo() {
        ...
        switch(actualInfo.getActualParentModule()){
			case OPPORTUNITIES:
				infoServer = TypeInfoServer.getLeadsxOpportunity;
				keyID = "idOpportunity";
				message = "Cargando Clientes Potenciales...";
				break;
			default:
					break;
		}
	...
	public void addInfo(String serverResponse) {
		...
		try {
			...
			if (tasksXParent.size() > 0) {
				...
				Message.showShort("No tiene clientes asociadas", getApplicationContext());
			}
		} catch (Exception e) {
