...
{
	//Importa el archivo que contiene el método
	require_once 'Servicios/getProductos.php';
...
$app->put('/editCliente', function ()
{
	...
	//Obtiene los parametros del header http
	$id = $app->request->headers->get('idCliente');
	$razonSocial = $app->request->headers->get('razonSocial');
	$nombre = $app->request->headers->get('nombre');
	$apellidos = $app->request->headers->get('apellidos');
	$telOficina = $app->request->headers->get('telOficina');
	$celular = $app->request->headers->get('celular');
	$fax = $app->request->headers->get('fax');
	$cargo = $app->request->headers->get('cargo');
	$direccion = $app->request->headers->get('direccion');
	$email = $app->request->headers->get('email');
	$web = $app->request->headers->get('web');
	$requerimiento = $app->request->headers->get('requerimiento');
	$valorEstimado = $app->request->headers->get('valorEstimado');
	$retroalimentacion1 = $app->request->headers->get('retroalimentacion1');
	$retroalimentacion2 = $app->request->headers->get('retroalimentacion2');
	$retroalimentacion3 = $app->request->headers->get('retroalimentacion3');
	$valorReal = $app->request->headers->get('valorReal');
	$departamento = $app->request->headers->get('departamento');
	$medio = $app->request->headers->get('medio');
	$marcas = $app->request->headers->get('marcas');
	$estado = $app->request->headers->get('estado');
	$accion = $app->request->headers->get('accion');
	$fecha1 = $app->request->headers->get('fecha1');
	$fecha2 = $app->request->headers->get('fecha2');
	$fecha3 = $app->request->headers->get('fecha3');
	$responsable1 = $app->request->headers->get('responsable1');
	$responsable2 = $app->request->headers->get('responsable2');
	$responsable3 = $app->request->headers->get('responsable3');
	$campana = $app->request->headers->get('campana');
	$idUsuarioAsignado = $app->request->headers->get('idUsuarioAsignado');
	$idUsuarioLogueado = $app->request->headers->get('idUsuarioLogueado');
	...
	$campana,$idUsuarioAsignado,$idUsuarioLogueado,'');
